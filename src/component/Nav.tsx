...
const Nav = ({ className }: { className: string }) => {
  ...
  return (
    <div
      className={`${className} absolute top-0 left-0 z-50 flex justify-between md:justify-around items-center w-full px-4 py-4 md:p-4`}
    >
      <div className="w-1/3 sm:w-1/4 md:w-1/7">
        <img
          className="w-20 sm:w-24 md:w-28"
          src="https://res.cloudinary.com/dtvr83fb3/image/upload/f_auto,q_auto/bzorlgo5a2hdo9xyljsi"
          alt="Logo"
        />
      </div>
